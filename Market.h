...
class Market {
    ...
    public:
        Market(){day = 0; name="Default"; head = new StockList();};
        Market(string name){day = 0; this->name = name; head = new StockList();};
        Market(string name, int market_num) {day = market_num; name=name; market_num = market_num; head = new StockList();};
        void readStockFile() {
